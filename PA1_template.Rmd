...
hist(totalSteps$x, col="lightblue", xlab= "Total DaIly Steps", ylab= "Frequency", main="", breaks=20)
```
...
plot(average$Interval, average$x, type = "l", col="blue", xlab = "Interval", ylab = "Mean number of steps", main="")
```

**Fig. 2: Average number of steps taken per 5-min interval.**
...
hist(new_totalSteps$x, col="lightblue", xlab= "Total DaIly Steps", ylab= "Frequency", main="", breaks=20)
```
